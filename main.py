...
parser.add_argument('--code', type=str, default="Encode", help='Encode or decode')
parser.add_argument('--file_path', type=str, default="default", help='Название файла или папки')
